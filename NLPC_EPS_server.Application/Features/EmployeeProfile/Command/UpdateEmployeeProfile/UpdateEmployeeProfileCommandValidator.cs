...
namespace NLPC_EPS_server.Application.Features.EmployeeProfile.Command.UpdateEmployeeProfile
{
    public class UpdateEmployeeProfileCommandValidator : AbstractValidator<UpdateEmployeeProfileCommand>
    {
        ...
        public UpdateEmployeeProfileCommandValidator(IEmployeeProfileRepository employeeProfileRepository, ICompanyRepository companyRepository)
        {
        ...
        private async Task<bool> EmployeeProfileNameUnique(UpdateEmployeeProfileCommand command, CancellationToken token)
        {
